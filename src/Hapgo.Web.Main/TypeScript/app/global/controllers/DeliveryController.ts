...
module Hapgo.global.controllers {
    export class DeliveryController {
        ...
        public seatList: Array<models.Track>;

        static $inject = ["Hapgo.global.services.DeliveryService"];
        constructor($service: interfaces.IDeliveryService) {
            require(['wizard', 'website'], (wizard, website) => {
                //
            ...
            this.seatList = new Array<models.Track>();
