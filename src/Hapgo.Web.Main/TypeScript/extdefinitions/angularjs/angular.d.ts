...
declare module angular {
    ...
    interface IRootScopeService {
        ...
        /**
         * Listens on couriers of a given type. See $emit for discussion of event life cycle.
         *
    ...
    interface IAngularEvent {
        ...
        name: string;
        /**
         * calling stopPropagation function will cancel further event propagation (available only for couriers that were $emit-ed).
         */
